...
TEST_F(GrammarTest, boolean_expression_complex) {
  lexer l;
  grammar g;
  token_base **base;
  ast_base *ret = NULL;
  ...
  char *op3 = (char *)malloc(sizeof(char) * 3);
  ...
  // Init stuff
  base = (token_base **)malloc(sizeof(token_base *) * 10);
  base[0] = (token_base *)malloc(sizeof(token_int_value));
  init_token_int_value((token_int_value *)base[0], 2);
  base[1] = (token_base *)malloc(sizeof(token_int_value));
  init_token_int_value((token_int_value *)base[1], 2);
  base[2] = (token_base *)malloc(sizeof(token_boolean_op));
  init_token_boolean_op((token_boolean_op *)base[2], op1);
  base[3] = (token_base *)malloc(sizeof(token_int_value));
  init_token_int_value((token_int_value *)base[3], 1);
  base[4] = (token_base *)malloc(sizeof(token_boolean_op));
  init_token_boolean_op((token_boolean_op *)base[4], op2);
  base[5] = (token_base *)malloc(sizeof(token_int_value));
  init_token_int_value((token_int_value *)base[5], 4);
  base[6] = (token_base *)malloc(sizeof(token_int_value));
  init_token_int_value((token_int_value *)base[6], 4);
  base[7] = (token_base *)malloc(sizeof(token_boolean_op));
  init_token_boolean_op((token_boolean_op *)base[7], op3);
  base[8] = (token_base *)malloc(sizeof(token_int_value));
  init_token_int_value((token_int_value *)base[8], 4);
  base[9] = (token_base *)malloc(sizeof(token_cpar));
  init_token_cpar((token_cpar *)base[9]);

  // Given
  next_fake.return_val_seq = base;
  next_fake.return_val_seq_len = 10;

  // When
  ret = read_boolean_expression(&g);

  // Then
  assert(next_fake.call_count == 10);
  assert(ret->type == A_BOOLEAN_OPERATOR);
}
...
TEST_F(GrammarTest, if_statement_inside_if_statement) {
  ...
  // Init stuff
  base = (token_base **)malloc(sizeof(token_base *) * 19);
  base[0] = (token_base *)malloc(sizeof(token_opar));
  init_token_opar((token_opar *)base[0]);
  base[1] = (token_base *)malloc(sizeof(token_int_value));
  init_token_int_value((token_int_value *)base[1], 1);
  ...
  base[17] = (token_base *)malloc(sizeof(token_cbra));
  init_token_cbra((token_cbra *)base[17]);
  base[18] = (token_base *)malloc(sizeof(token_eof));
  init_token_eof((token_eof *)base[18]);

  // Given
  next_fake.return_val_seq = base;
  next_fake.return_val_seq_len = 19;

  // When
  ret = read_if_statement(&g);

  // Then
  assert(next_fake.call_count == 19);
  assert(ret != NULL);
  assert(ret->type == A_IF);
}
...
TEST_F(GrammarTest, if_statement_inside_else_statement) {
  ...
  // Init stuff
  base = (token_base **)malloc(sizeof(token_base *) * 21);
  base[0] = (token_base *)malloc(sizeof(token_opar));
  init_token_opar((token_opar *)base[0]);
  base[1] = (token_base *)malloc(sizeof(token_int_value));
  init_token_int_value((token_int_value *)base[1], 1);
  ...
  base[10] = (token_base *)malloc(sizeof(token_if));
  init_token_if((token_if *)base[10]);
  base[11] = (token_base *)malloc(sizeof(token_opar));
  init_token_opar((token_opar *)base[11]);
  base[12] = (token_base *)malloc(sizeof(token_int_value));
  init_token_int_value((token_int_value *)base[12], 1);
  base[13] = (token_base *)malloc(sizeof(token_int_value));
  init_token_int_value((token_int_value *)base[13], 1);
  base[14] = (token_base *)malloc(sizeof(token_boolean_op));
  init_token_boolean_op((token_boolean_op *)base[14], op2);
  base[15] = (token_base *)malloc(sizeof(token_int_value));
  init_token_int_value((token_int_value *)base[15], 1);
  base[16] = (token_base *)malloc(sizeof(token_cpar));
  init_token_cpar((token_cpar *)base[16]);
  base[17] = (token_base *)malloc(sizeof(token_obra));
  init_token_obra((token_obra *)base[17]);
  base[18] = (token_base *)malloc(sizeof(token_cbra));
  init_token_cbra((token_cbra *)base[18]);

  base[19] = (token_base *)malloc(sizeof(token_cbra));
  init_token_cbra((token_cbra *)base[19]);
  base[20] = (token_base *)malloc(sizeof(token_cbra));
  init_token_cbra((token_cbra *)base[20]);


  // Given
  next_fake.return_val_seq = base;
  next_fake.return_val_seq_len = 21;

  // When
  ret = read_if_statement(&g);

  // Then
  assert(next_fake.call_count == 21);
  assert(ret != NULL);
  assert(ret->type == A_IF);
}
...
int main() {
  ...
  RUN_TEST(GrammarTest, boolean_expression_complex);
